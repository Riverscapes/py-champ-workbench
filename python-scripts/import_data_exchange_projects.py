"""
Script to update postgres with the GUIDs of projects that are already in
...
This was originally written just to process Asotin projects, but has since been genericized
to work with any project type.
...
data_file = os.path.join(Path(__file__).resolve().parents[1], '..', 'champ_substrate_projects.csv')
